function REncrypt() {
    plaintext =document.getElementById('inputtext').value.toLowerCase().replace(/[^a-z]/g, "");  
...
function RDecrypt(f) {
    ciphertext = document.getElementById('inputtext').value.toLowerCase().replace(/[^a-z]/g, "");
